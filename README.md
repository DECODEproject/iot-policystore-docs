# Decode PolicyStore OpenAPI Specification
[![Build Status](https://travis-ci.com/DECODEproject/iot-policystore-docs.svg?branch=master)](https://travis-ci.com/DECODEproject/iot-policystore-docs)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://decodeproject.github.io/iot-policystore-docs/)
- OpenAPI Raw Files: [JSON](https://decodeproject.github.io/iot-policystore-docs/openapi.json) [YAML](https://decodeproject.github.io/iot-policystore-docs/openapi.yaml)
